                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="sidebar sidebar-right">
                            ...
                            <div id="woocommerce_product_categories-1"
                                ...
                                <ul class="product-categories">
                                    ...
                                    <li class="cat-item cat-item-18"><a
                                            href="{{url('all_product_category',$category->id)}}">{{$category->category_name}}</a></li>
                                    @endforeach
                            ...
                            <div id="woocommerce_product_tag_cloud-2"
                                ...
                                <div class="tagcloud">
                                    @foreach ($all_brand as $brand1)

                                    <a href="{{url('all_product_brand',$brand1->id)}}"
                                        class="tag-cloud-link tag-link-24 tag-link-position-1"
                                        style="font-size: 15.368421052632pt;"
                                        aria-label="Beauty (8 products)">{{$brand1->brand_name}}</a>
