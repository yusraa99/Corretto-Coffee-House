...
<div id="app">
    ...
    <div class="card-content" >
        ...
        <table >
            <thead >
                <tr>
                    <th style="text-align: center">Comment Created at</th>
                    <th style="text-align: center">Post Title</th>
                    <th style="text-align: center">Users Name</th>
                    <th style="text-align: center">Comment Body</th>
                    <th></th>
                </tr>
            </thead>
            <tbody>
                @foreach ($data as $data)
                    ...
                    <tr>
                        ...
                        <td data-label="Name" style="text-align: center">{{$data->post->title}}</td>

                        <td data-label="Brand" style="text-align: center">{{$data->user->name}}</td>
                        ...
                        <td class="actions-cell">
                            <div class="buttons right nowrap">
                                <button class="button small red --jb-modal" data-target="sample-modal" type="submit">
                                    <a href="{{url('delete_comment',$data->id)}}"onclick="return confirm('Are You Sure To Delete This Item ?..')"><span class="icon"><i class="mdi mdi-trash-can"></i></span></a>
                                </button>
                            </div>
                        </td>
                    </tr>
