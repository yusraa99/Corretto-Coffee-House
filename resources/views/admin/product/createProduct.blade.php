        ...
        <form action="{{url('create_product')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="field-body">
                    <div class="field">
                        <div class="control icons-left">
                            <input name="product" class="input" type="text" placeholder="Please Enter Product Name" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="field-body">
                    <div class="field">
                        <div class="control icons-left">
                            <textarea name="description" class="textarea" placeholder="Explain The Product"></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="field-body">
                    <div class="field">
                        <div class="control icons-left">
                            <input name="price" class="input" type="text" placeholder="Please Enter Product Price" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="field-body">
                    <div class="field">
                        <div class="control icons-left">
                            <input name="quantity" class="input" type="text" placeholder="Please Enter Product Quantity" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="field-body">
                    <div class="field">
                        <div class="control icons-left">
                            <input name="productcode" class="input" type="text" placeholder="Please Enter Product Code" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="field-body">
                    <div class="field">
                        <div class="control icons-left">
                            <input name="discount" class="input" type="text" placeholder="Please Enter Product Code" required>
                        </div>
                    </div>
                </div>
            </div>
